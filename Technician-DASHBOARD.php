...
<?php 
  ...
  $user_list = '';
	...
	if ($users) {
      ...
      // $user_list .= "<td><a href=\"Scheduling-page.php?user_id={$user['id']}\">Add</a></td>";
...
<link rel="stylesheet" href="css/Technician-Dashboard.css" media="screen">
    ...
    <meta property="og:title" content="Technician Dashboard">
...
<!-- </li><li class="u-nav-item"><a class="u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-button-style u-nav-link u-radius-14 u-text-active-grey-5 u-text-hover-custom-color-1 u-text-white" href="Login.php" style="padding: 10px 24px;">Login</a> -->
    ...
    <section class="u-clearfix u-image u-shading u-section-1" id="sec-6762" data-image-width="2000" data-image-height="1380">
      <p class="u-text u-text-default u-text-1"><span class="u-icon"></span>&nbsp;Welcome !&nbsp;&nbsp;<span style="text-decoration:  !important;"><?php echo "Technician". $_SESSION['user_id']; ?></span>
      </p>
      ...
      <p class="u-text u-text-default u-text-2">
        <a class="u-border-none u-btn u-btn-round u-button-style u-grey-5 u-hover-custom-color-1 u-radius-23 u-btn-1" href="Scheduling-page.php"><span class="u-file-icon u-icon"><img src="images/8867438.png" alt=""></span>&nbsp;+ Add Scheduling for Employees
        </a>
      </p>
