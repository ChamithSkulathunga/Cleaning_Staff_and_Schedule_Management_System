...
<?php 
	...
	if (isset($_POST['submit'])) {
		...
		if (empty($errors)) {
			...
			$query = "SELECT * FROM login_technician
						WHERE email = '{$email}' 
			...
			if ($result_set) {
				...
				if (mysqli_num_rows($result_set) == 1) {
					// valid user found
					$login_technician = mysqli_fetch_assoc($result_set);
					$_SESSION['user_id'] = $login_technician['id'];
					$_SESSION['first_name'] = $login_technician['first_name'];
...
<link rel="stylesheet" href="css/Technician-login.css" media="screen">
    ...
    <meta property="og:title" content="Technician-login">
...
<!-- </li><li class="u-nav-item"><a class="u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-button-style u-nav-link u-radius-14 u-text-active-grey-5 u-text-hover-custom-color-1 u-text-white" href="Login.php" style="padding: 10px 24px;">Login</a> -->
    ...
    <section class="u-clearfix u-custom-color-2 u-section-1" id="sec-0ed6">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-group u-radius-30 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-valign-top u-container-layout-1">
            <p class="u-text u-text-default u-text-1"> TECHNIC<span style="font-weight: 700;"></span>ION
            </p>
          </div>
        </div>
        <div class="u-align-center u-border-1 u-border-grey-75 u-form u-login-control u-radius-50 u-white u-form-1">
          <form action="Technician-login.php"  method="post" class="u-clearfix u-form-custom-backend u-form-spacing-8 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 50px;">
          <?php 
        ...
        <?php 
          ...
          <div class="u-form-group u-form-name">
              ...
              <input type="text" placeholder="Enter email address" id="" name="email" class="u-input u-input-rectangle u-none u-radius-12 u-input-1" required="">
            </div>
            ...
            <div class="u-align-left u-form-group u-form-submit">
              <a href="#" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-custom-color-3 u-radius-50 u-text-white u-btn-1">Login</a>
