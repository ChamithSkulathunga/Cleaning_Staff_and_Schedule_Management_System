		...
		if (empty($errors)) {
			...
			if ($result_set) {
				...
				if (mysqli_num_rows($result_set) == 1) {
					// valid user found
					$login_admin = mysqli_fetch_assoc($result_set);
					$_SESSION['user_id'] = $login_admin['id'];
					$_SESSION['first_name'] = $login_admin['first_name'];
...
<!-- </li><li class="u-nav-item"><a class="u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-button-style u-nav-link u-radius-14 u-text-active-grey-5 u-text-hover-custom-color-1 u-text-white" href="Login.php" style="padding: 10px 24px;">Login</a> -->
    ...
    <section class="u-clearfix u-custom-color-2 u-section-1" id="sec-114b">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-group u-radius-30 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <p class="u-text u-text-default u-text-1">ADMIN</p>
          </div>
        </div>
        <div class="u-align-center u-border-1 u-border-grey-75 u-form u-login-control u-radius-50 u-white u-form-1">
          <form action="Admin-login.php" method="post" class="u-clearfix u-form-custom-backend u-form-spacing-8 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 50px;">
